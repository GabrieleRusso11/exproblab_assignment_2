#include <ros/ros.h>
#include <exproblab_assignment_2/RoomConnection.h>
#include <exproblab_assignment_2/RoomInformation.h>

bool markerCallback(exproblab_assignment_2::RoomInformation::Request &req, exproblab_assignment_2::RoomInformation::Response &res){
	exproblab_assignment_2::RoomConnection conn;
	switch (req.id){
	case 11:
		res.room = "E";
		res.x = 1.5;
...
{
	ros::init(argc, argv, "exproblab_assignment_2");
	ros::NodeHandle nh;
